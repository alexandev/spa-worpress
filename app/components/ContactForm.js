export function ContactForm(){
    ...
    $form.innerHTML = `
        ...
        <textarea name="comments" id="" cols="50" rows="5" placeholder="Escribe tus comentarios" data-pattern="^.{1,255}$" title="Tu comentario no debe exceder los 255 caracteres" required></textarea>
        <input type="submit" value="Enviar"/>

        <div class="contact-form-loader none">
        <img src="http://samherbert.net/svg-loaders/svg-loaders/tail-spin.svg" alt="Cargando">
        </div>
    ...
    const validarInputs = (inputsArray)=>{
    ...
    function contactFormValidations(){
        ...
        d.addEventListener("submit", e=>{
            ...
            fetch( "https://formsubmit.co/ajax/jamcy9@gmail.com", {
                method: "POST",
